...
public class RateLimitPolicyAttributeTests
{
    ...
    [InlineData(typeof(AuthController), nameof(AuthController.SendVerificationCode), RateLimitPolicyNames.AuthEmail)]
    [InlineData(typeof(AuthController), nameof(AuthController.ResendVerificationCode), RateLimitPolicyNames.AuthEmail)]
    [InlineData(typeof(AuthController), nameof(AuthController.VerifyEmailCode), RateLimitPolicyNames.AuthEmail)]
