...
/// <see cref="UserSubscription.ProviderCustomerId"/> / <see cref="UserSubscription.ProviderSubscriptionId"/> para correlacionar com o gateway.
/// </summary>
public interface IUserSubscriptionRepository
{
    ...
    /// <summary>Resolução por id Stripe (webhooks idempotentes).</summary>
